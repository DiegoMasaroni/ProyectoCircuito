        ...
        <section>
            ...
            <form action="cargaForm.jsp" class="container-fluid" style="width: 63%" >
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <select id="estadia" name="categoria" class="form-select" aria-label="Default select example">
                            ...
                            <option value="0">Lunes a Jueves (50%)</option>
                            <option value="1">Viernes, Sábados o Domingo (100%)</option>
                            <option value="2">Vie y Sáb o Sáb y Dom (20%)</option>
                        </select>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    ...
                    <div class="d-grid col-6 mx-auto">
                        <button class="btn btn-success" type="submit" id="btnResumen">Emitir cupón de pago</button>
